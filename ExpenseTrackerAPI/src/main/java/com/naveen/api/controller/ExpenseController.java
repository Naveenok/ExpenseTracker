package com.naveen.api.controller;
...
import com.naveen.api.service.ExpenseService;
...
public class ExpenseController {
	...
	public ResponseEntity<?> getByMonthYear(@PathVariable("year") Integer year, @PathVariable("month") String month) {
